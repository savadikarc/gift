...
from gift.vis_utils import ClusterVisualizer
...
group.add_argument(
    ...
    type=int,
    default=-1,
    help="GIFT hypernet layer to visualize if using any block other than simple_block",
)
group.add_argument(
    "--epoch_to_visualize",
    type=int,
...
def main():
    ...
    visualizer = ClusterVisualizer(model, device=device, gift_layer=args.gift_layer, mean=data_config["mean"], std=data_config["std"])
