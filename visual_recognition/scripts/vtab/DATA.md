...
```
### Caltech101
- ```tensorflow-datasets==4.9.3``` should be used instead of ```tfds-nightly==4.4.0.dev202201080107``` as used by the other datasets. Please follow the instructions in [visual_recognition/README.md](/visual_recognition/README.md) to create the environment.
