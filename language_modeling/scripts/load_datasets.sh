...
# clone the LLM-Adapters repository (forked from https://github.com/AGI-Edgerunners/LLM-Adapters)
git clone --depth=1 https://github.com/savadikarc/LLM-Adapters.git
# clone repository for holding ultrafeedback dataset (forked from https://github.com/frankaging/ultrafeedback-dataset)
git clone --depth=1 https://github.com/savadikarc/ultrafeedback-dataset.git
